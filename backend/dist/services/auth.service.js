...
// Support for JWT secret rotation - allows for old and new secrets during rotation
const JWT_SECRET = process.env.JWT_SECRET || "your_jwt_secret";
const JWT_SECRET_OLD = process.env.JWT_SECRET_OLD; // Previous secret during rotation
class AuthService {
    ...
    isPredictablePattern(pin) {
        ...
        const commonPatterns = ['1234', '2345', '3456', '4567', '5678', '6789', '7890',
