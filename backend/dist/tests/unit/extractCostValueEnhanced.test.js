...
describe('Flexible data validation for different number formats', () => {
    ...
    it('should handle numbers with thousands separators only', () => {
        ...
        const result = (0, product_service_1.extractCostValueEnhanced)('1.000');
        ...
        const result2 = (0, product_service_1.extractCostValueEnhanced)('1.000.000');
    ...
    it('should handle various edge cases', () => {
        ...
        const result = (0, product_service_1.extractCostValueEnhanced)('1.234.567');
        expect(result).not.toBeNaN();
