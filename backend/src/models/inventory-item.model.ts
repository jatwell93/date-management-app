...
export class InventoryItemModel {
   ...
   */
  async create(inventoryData: Omit<InventoryItem, 'id' | 'createdAt' | 'updatedAt'>): Promise<InventoryItem> {
    ...
    return {
      ...
      status: result.status as 'Normal' | 'Markdown 1' | 'Markdown 2' | 'Markdown 3' | 'Expired',
   ...
   */
  async update(id: number, updateData: Partial<Omit<InventoryItem, 'id' | 'createdAt' | 'updatedAt'>>): Promise<InventoryItem | null> {
