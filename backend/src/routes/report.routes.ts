...
router.get('/expiry', authenticateToken, async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.get('/expiry-overall', authenticateToken, async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    const { reportService } = getServicesForRequest(req);
...
router.get('/expiry-details', authenticateToken, async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    const { reportService } = getServicesForRequest(req);
...
router.get('/monthly-markdown', authenticateToken, async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    const { reportService } = getServicesForRequest(req);
...
router.post('/update-statuses', authenticateToken, async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    const { reportService } = getServicesForRequest(req);
...
router.get('/daily-usage', authenticateToken, async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    const { reportService } = getServicesForRequest(req);
...
router.get('/loss-by-sku', authenticateToken, async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    const { reportService } = getServicesForRequest(req);
...
router.get('/loss-by-department', authenticateToken, async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    const { reportService } = getServicesForRequest(req);
...
router.get('/items-by-user', authenticateToken, async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.get('/items-by-date', authenticateToken, async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    const { reportService } = getServicesForRequest(req);
