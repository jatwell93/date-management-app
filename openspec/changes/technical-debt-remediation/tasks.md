...
- [ ] 5.1 Split subscription lifecycle logic into smaller units for trial setup, billing state, and access checks.
- [ ] 5.2 Move any remaining mixed-responsibility logic out of the subscription service once the split is in place.
- [ ] 5.3 Refactor any other oversized service that still mixes unrelated responsibilities after the first three decompositions.
