...
describe('applySecurityHeaders', () => {
  it('sets nosniff, an API lockdown CSP, referrer and permissions policy', () => {
    const response = applySecurityHeaders(new Response('{}'), httpsRequest());
  ...
  it('does not send HSTS over plain http', () => {
    ...
    // undo.
    const response = applySecurityHeaders(new Response('{}'), httpRequest());
  ...
  it('never overwrites a header a handler set deliberately', () => {
    ...
    const response = applySecurityHeaders(existing, httpsRequest());
  ...
  it('preserves status, body and pre-existing headers', () => {
    ...
    const response = applySecurityHeaders(original, httpsRequest());
  ...
  it('handles a response whose headers are immutable', async () => {
    ...
    const response = applySecurityHeaders(redirect, httpsRequest());
